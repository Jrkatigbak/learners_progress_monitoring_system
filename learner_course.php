...
if ($certificateDownloadsEnabled) {
    $moduleCards[] = ['label' => 'Certificates', 'icon' => 'fa-award', 'count' => 1, 'url' => 'student-certificate.php?course_id=' . $courseId];
}
?>
<!doctype html>
<html lang="en">
          ...
          <?php else: ?>
            <div class="learner-course-list">
              <article class="learner-course-list-item">
                ...
                <a class="btn btn-sm btn-primary" href="student-certificate.php?course_id=<?php echo $courseId; ?>">
                  View
                </a>
              </article>
            </div>
